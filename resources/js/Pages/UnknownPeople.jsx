...
import UnknownPeopleHeader from "../Components/Friends/UnknownPeopleHeader";
import UnknownPeopleContent from "../Components/Friends/UnknownPeopleContent";


export default function UnknownPeople(props) {
        ...
        <HomeLayout>
            <div className="page-main flex">
                ...
                <div className="page flex-auto w-full border-solid border-2 border-sky-500 p-[20px]">
                    <UnknownPeopleHeader {...props}/>
                    <UnknownPeopleContent {...props}/>
                </div>
            </div>
        </HomeLayout>
    );
